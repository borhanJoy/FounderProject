    ...
    <div class="body">
        ...
        <div class="container py-4">
            ...
            <h4 class="tp-caption font-weight-light ws-normal text-center"
                ...
                style="color: #000000;"><font color="red"><strong>Wrong..Think Bigger!</strong></font><br><br> {{$categories->suggestion}}<strong></strong> </h4>

            @if($categories->option_one != $categories->answer)
                <center><div class="btn">
                        <button class="btn btn-danger rounded-0  font-weight-semibold btn-px-5 btn-py-2 border-width-1 text-1" disabled>{{$categories->option_one}}</button>
            ...
            @elseif($categories->option_two != $categories->answer)
                <center><div class="btn">
                        ...
                        <button class="btn btn-danger rounded-0  font-weight-semibold btn-px-5 btn-py-2 border-width-1 text-3" disabled>{{$categories->option_two}}</button>
                        <button  class="btn btn-light rounded-0  font-weight-semibold btn-px-5 btn-py-2 border-width-1 text-1" disabled>{{$categories->option_three}}</button>
                    </div></center>
            @elseif($categories->option_three != $categories->answer)
                <center><div class="btn">
                        <button class="btn btn-light rounded-0  font-weight-semibold btn-px-5 btn-py-2 border-width-1 text-1" disabled>{{$categories->option_one}}</button>
                        <button class="btn btn-light rounded-0  font-weight-semibold btn-px-5 btn-py-2 border-width-1 text-3" disabled>{{$categories->option_two}}</button>
                        <button  class="btn btn-danger rounded-0  font-weight-semibold btn-px-5 btn-py-2 border-width-1 text-1" disabled>{{$categories->option_three}}</button>
                    </div></center>
            @endif
{{--            <center><div class="btn">--}}
{{--                    <button class="btn btn-light rounded-0  font-weight-semibold btn-px-5 btn-py-2 border-width-1 text-1" disabled>{{$categories->option_one}}</button>--}}
{{--                    <button  class="btn btn-danger rounded-0  font-weight-semibold btn-px-5 btn-py-2 border-width-1 text-1" disabled >{{$categories->option_two}}</button>--}}
{{--                    <button class="btn btn-success rounded-0  font-weight-semibold btn-px-5 btn-py-2 border-width-1 text-3" disabled>{{$categories->option_three}}</button>--}}
{{--                </div></center>--}}
