    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <div class="card mt-10">
                ...
                <div class="card-body">
                    <h1 class="mt-4 mb-3 text-center">Login Now!</h1>
                    <h3 class="text-center text-danger">{{Session::get('message')}}</h3>
                    <form action="{{route('user.log.in')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="submit"  class="pix-btn" value="Login">
